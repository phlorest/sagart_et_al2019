...
- Re-create the CLDF dataset:
  ```shell
  cldfbench makecldf --glottolog-version v5.2 cldfbench_sagart_et_al2019.py --with-zenodo --with-cldfreadme
  ```
...
- Re-create the README:
  ```shell
  cldfbench readme cldfbench_sagart_et_al2019.py
  ```
- Run Phlorest-specific checks on the data:
  ```shell
  phlorest check --with-R cldfbench_sagart_et_al2019.py
  ```
...
- Create the release instruction:
  ```shell
  phlorest release cldfbench_sagart_et_al2019.py vX.Y
  ```
